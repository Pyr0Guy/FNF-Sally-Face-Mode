...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Ruv',					'ruv',		  		'Second Coder',							'https://youtube.com/channel/UC-A1OmEN7_EDKtz_uUQnzGg',		'aa9683'],
			[''],
			['Psych Engine Team'],
		...
		descText.setFormat(Paths.font("coolFont.ttf"), 32, FlxColor.WHITE, CENTER/*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);

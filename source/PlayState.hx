...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'podval': //SallyWeek 1
				...
				var bg:BGSprite = new BGSprite('undeground/bg', -1150, -650, 0.9, 0.9);
				bg.updateHitbox();
				bg.antialiasing = ClientPrefs.globalAntialiasing;
				add(bg);

				var flor:BGSprite = new BGSprite('undeground/flor', -850, -550, 0.9, 0.9);
				flor.updateHitbox();
				flor.antialiasing = ClientPrefs.globalAntialiasing;
				add(flor);

				var someStaff:BGSprite = new BGSprite('undeground/someStaff', -850, -550, 0.9, 0.9);
				...
				var provod:BGSprite = new BGSprite('undeground/fg-provod', -700, -180,  1.3, 1.3);
				provod.updateHitbox();
				provod.antialiasing= ClientPrefs.globalAntialiasing;
				add(provod);

				var huina:BGSprite = new BGSprite('undeground/fg-huina', -600, -680,  1.2, 1.2);
				huina.updateHitbox();
		...
		//У меня теперь 2 бати, я думал это не дота
		dad2 = new Character(dad.x - 200, dad.y + 100 , SONG.player3);
		...
		timeTxt.setFormat(Paths.font("coolFont.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("coolFont.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("coolFont.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		if ((isStoryMode || ses == 1) && !seenCutscene)
		{
			switch (daSong)
			{
				case "monster":
		...
		switch(type) {
			...
			case 2:
				if(gf != null && !gfMap.exists(newCharacter)) {
					...
					newGf.scrollFactor.set(0.9, 0.9);
	...
	override public function update(elapsed:Float)
	{
		...
		//startDialogue(dialogue, 'dreams-of-funking');
